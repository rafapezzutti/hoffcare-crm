      ...
      <div className="login-page">
        <div className="login-card">
          <div style={{ textAlign: 'center', padding: '24px 0' }}>
            <div style={{ fontSize: 40, color: '#dc3545', marginBottom: 16 }}><i className="fas fa-triangle-exclamation" /></div>
            <p style={{ fontSize: 14, color: '#495057' }}>Link inválido. Solicite uma nova redefinição de senha.</p>
            <button className="btn btn-primary" onClick={() => navigate('/forgot-password')} style={{ marginTop: 20 }}>
              Solicitar novo link
            </button>
          </div>
        </div>
    ...
    <div className="login-page">
      <div className="login-card">
        <div className="login-logo">
          ...
          <h1 style={{ marginTop: 16, fontSize: 15, fontWeight: 600, color: '#495057' }}>Criar nova senha</h1>
        </div>

        {done ? (
          <div style={{ textAlign: 'center', padding: '8px 0 16px' }}>
            <div style={{ fontSize: 40, color: '#28a745', marginBottom: 16 }}>
            ...
            <button className="btn btn-primary" onClick={() => navigate('/login')} style={{ width: '100%', justifyContent: 'center' }}>
              <i className="fas fa-right-to-bracket" /> Ir para o login
            </button>
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                {loading
                  ...
                  : <><i className="fas fa-lock" /> Salvar nova senha</>
                }
              </button>
            </form>
          </>
